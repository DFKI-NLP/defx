...
local oversampling_ratio = std.extVar("OVERSAMPLING_RATIO");
local majority_description = std.extVar("MAJORITY_DESCRIPTION");
...

{
  ...
  "dataset_reader": {
    ...
    "majority_description": majority_description,
    "token_indexers": {
      "tokens": {
